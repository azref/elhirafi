...
import '../../data/cities_data.dart'; // <-- تم التعديل هنا
  ...
  Future<void> _register() async {
    ...
    try {
      await authProvider.register(
        ...
        profileImage: _image, // <-- تم التعديل هنا
      );
...
class _CitySelectionDialogState extends State<_CitySelectionDialog> {
  ...
  List<String> get _filteredCities {
    ...
    final cities = citiesByCountry[_selectedCountry] ?? []; // <-- تم التعديل هنا
        ...
        child: Column(
          ...
          children: [
            DropdownButton<String>(
              ...
              isExpanded: true,
              items: citiesByCountry.keys.map((String country) { // <-- تم التعديل هنا
                return DropdownMenuItem<String>(
                  value: country,
                  child: Text(country),
                );
