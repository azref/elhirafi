...
class _AvailableCraftsmenScreenState extends State<AvailableCraftsmenScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final userCountry = currentUser?.country ?? 'MA';
    final availableCities = CitiesData.getCitiesForCountry(userCountry);
    final professions = ProfessionsData.getAllProfessions();
                  ...
                  items: [
                    ...
                    ...professions.map((profession) {
                      return DropdownMenuItem(
                        value: profession.id,
                        child: Text(profession.getNameByDialect(userCountry)),
                      );
                    }),
                  ],
                  onChanged: (value) {
