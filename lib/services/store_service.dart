...
class StoreService {
  ...
  Future<int> getOrdersCount(String supplierId) async {
    // TODO: Implement actual order counting logic
  ...
  Future<bool> deleteProduct(String productId, List<String> imageUrls) async {
    try {
      ...
      for (String imageUrl in imageUrls) {
        try {
          // Ensure the URL is a valid gs:// or https:// URL before trying to delete
          if (imageUrl.startsWith('gs://') || imageUrl.startsWith('https://')) {
            await _storage.refFromURL(imageUrl).delete();
          }
        } catch (e) {
          // Log error but continue, as the main goal is to delete the product document
